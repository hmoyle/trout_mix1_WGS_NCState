---
title: "rep 4 Admixture Proportions"
...
```{r K3, echo = FALSE}
q <- read.table("data/ngsadmix/maf_0.05/K_3_rep_4/output.qopt")
ord <- orderInds(q = q, pop = water_name, popord = popord)
r <- read.table("data/evaladmix/maf_0.05/K_3_rep_4/output.corres.txt")
...
barplot(t(q)[,ord], 
        ...
        cex.axis = 1.1,
        cex.lab = 1.3,
        ylab = "Admixture proportions for K = 3 (rep 4)",
        xlab = "",
        xpd = NA,
        names = metadata$NMFS_DNA_ID...1[ord],
        las = 2,
...
```{r K4, echo = FALSE}
q <- read.table("data/ngsadmix/maf_0.05/K_4_rep_4/output.qopt")
ord <- orderInds(q = q, pop = water_name, popord = popord)
r <- read.table("data/evaladmix/maf_0.05/K_4_rep_4/output.corres.txt")
...
barplot(t(q)[,ord], 
        ...
        cex.axis = 1.1,
        cex.lab = 1.3,
        ylab = "Admixture proportions for K = 4 (rep 4)",
        xlab = "",
        xpd = NA,
        names = metadata$NMFS_DNA_ID...1[ord],
        las = 2,
...
```{r K5, echo = FALSE}
q <- read.table("data/ngsadmix/maf_0.05/K_5_rep_4/output.qopt")
ord <- orderInds(q = q, pop = water_name, popord = popord)
r <- read.table("data/evaladmix/maf_0.05/K_5_rep_4/output.corres.txt")
...
barplot(t(q)[,ord], 
        ...
        cex.axis = 1.1,
        cex.lab = 1.3,
        ylab = "Admixture proportions for K = 5 (rep 4)",
        xlab = "",
        xpd = NA,
        names = metadata$NMFS_DNA_ID...1[ord],
        las = 2,
...
```{r K7, echo = FALSE}
q <- read.table("data/ngsadmix/maf_0.05/K_7_rep_4/output.qopt")
ord <- orderInds(q = q, pop = water_name, popord = popord)
r <- read.table("data/evaladmix/maf_0.05/K_7_rep_4/output.corres.txt")
...
barplot(t(q)[,ord], 
        ...
        cex.axis = 1.1,
        cex.lab = 1.3,
        ylab = "Admixture proportions for K = 7 (rep 4)",
        xlab = "",
        xpd = NA,
        names = metadata$NMFS_DNA_ID...1[ord],
        las = 2,
...
```{r K9, echo = FALSE}
q <- read.table("data/ngsadmix/maf_0.05/K_9_rep_4/output.qopt")
ord <- orderInds(q = q, pop = water_name, popord = popord)
r <- read.table("data/evaladmix/maf_0.05/K_9_rep_4/output.corres.txt")
...
barplot(t(q)[,ord], 
        ...
        cex.axis = 1.1,
        cex.lab = 1.3,
        ylab = "Admixture proportions for K = 9 (rep 4)",
        xlab = "",
        xpd = NA,
        names = metadata$NMFS_DNA_ID...1[ord],
        las = 2,
...
```{r K10, echo = FALSE}
q <- read.table("data/ngsadmix/maf_0.05/K_10_rep_4/output.qopt")
ord <- orderInds(q = q, pop = water_name, popord = popord)
r <- read.table("data/evaladmix/maf_0.05/K_10_rep_4/output.corres.txt")
...
barplot(t(q)[,ord], 
        ...
        cex.axis = 1.1,
        cex.lab = 1.3,
        ylab = "Admixture proportions for K = 10 (rep 4)",
        xlab = "",
        xpd = NA,
        names = metadata$NMFS_DNA_ID...1[ord],
        las = 2,
